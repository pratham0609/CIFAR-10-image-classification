...
● Linear Layer (output size = 10)  <br />
● Softmax Classification  <br />
Convolutional layers have tanh activation while fully connected layers have ReLu activation.  <br />
For 40 epochs, this gave 67.54% accuracy.  <br />
